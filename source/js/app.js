define(['bootstrap', 'autocompleteMediator', 'lib/vendors/atomic'], function (news, AutocompleteMediator, atomic) {

    atomic.get('http://www.bbc.co.uk/indepthtoolkit/data-sets/how_did_my_mp_vote/json-with-props')
